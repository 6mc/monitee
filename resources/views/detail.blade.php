...
<div class="main-ui playlist">
  <input onchange="console.log(this.value);" class="handle" type="range" min="0" max="400" style="width:94%; margin-left:3%; border-style: inset;
    border-color: #7e7e7e;
    border-width: 2px;
  ...
  <div class="inner">
    <div class="list b-black" style="    width: max-content;
    margin-left: auto;
    margin-right: auto;
    min-height: auto;">
      <!-- <ul>
      ...
      <img src="http://spantags.net/nefertari/demo1/assets/images/people/101.jpg">
    </div>
    <div class="control">
      <button>Queue</button>
